...
?>
	<div class="form-field" style="position: relative;">
		...
		get_job_manager_template(
			'form-fields/business-hours-field.php', array(
				'key'   => 'job_hours',
				'field' => $field,
			)
		);
...
<?php
	...
	public function register_scripts() {
		wp_register_script( 'timepicker', Listify_Integration::get_url() . 'js/vendor/timepicker/jquery.timepicker.min.js', array( 'jquery' ), '1.11.5', true );
		wp_register_style( 'timepicker', Listify_Integration::get_url() . 'js/vendor/timepicker/jquery.timepicker.css', array(), '1.11.5' );
	}
