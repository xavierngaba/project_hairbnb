...
class Listify_WP_Job_Manager_Template_Single_Listing {
	...
	public static function enqueue_scripts() {
		...
		$map_vars = apply_filters(
			'listify_single_map_settings', array(
		...
		wp_enqueue_script( 'listify-app-listing', get_template_directory_uri() . '/inc/integrations/wp-job-manager/js/listing/app.min.js', array( 'jquery', 'listify', 'wp-util', 'listify-map' ), listify_get_version(), true );
	...
	public static function the_secondary_image() {
		...
		listify_the_listing_secondary_image(
			null, array(
