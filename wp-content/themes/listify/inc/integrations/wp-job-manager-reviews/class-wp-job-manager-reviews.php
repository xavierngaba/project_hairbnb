...
class Listify_WP_Job_Manager_Reviews extends Listify_Integration {
	...
	public function scripts() {
		...
		wp_register_script( 'listify-wpjm-reviews-gallery', self::get_url() . 'js/gallery.js', array( 'jquery', 'listify' ), listify_get_version(), true );
	}
	...
	public function rating_average( $average, $listing ) {
		return wpjmr_get_reviews_average( $listing->get_id() );
	}
